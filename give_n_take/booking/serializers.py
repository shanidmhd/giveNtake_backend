...
class Ticket_Booking_serializer(serializers.ModelSerializer):
    ...
    fk_program =serializers.IntegerField(required=True)
    class Meta :
        model = TicketBooking
        fields = '__all__'
    ...
    def to_representation(self, instance):
        ...
        res['fk_program']=Program_model.objects.filter(id=res['fk_program']).values('id','program_name','venue','date','available_seats')
        return res
